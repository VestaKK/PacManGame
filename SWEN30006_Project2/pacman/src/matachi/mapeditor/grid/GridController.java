...
//		this.drawingMode = true;
	...
	public void mousePressed(MouseEvent e) {
		lastClickedTileX = e.getX() / TileManager.getTileWidth();
		lastClickedTileY = e.getY() / TileManager.getTileHeight();
	...
	private void updateTile(int xCor, int yCor) {
		xCor = Math.max(0, Math.min(xCor, camera.getModelWidth()-1));
		yCor = Math.max(0, Math.min(yCor, camera.getModelHeight()-1));
	...
	public void mouseDragged(MouseEvent e) {
		if (ifRightMouseButtonPressed(e)) {
			int newTileX = e.getX() / TileManager.getTileWidth();
			int newTileY = e.getY() / TileManager.getTileHeight();
